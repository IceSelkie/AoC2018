...
public class TheSumOfItsParts
{
  ...
  public static void main(String[] args)
  {
    ...
    Pair<Integer, String>[] workers = pa(testSet ? 2 : 5, new Pair<Integer, String>(0, null));
    ...
    while (!remaining.isEmpty())
    {
      ...
      for (int i = 0; i < workers.length; i++)
        ...
        {
          workers[i] = p(s.compareTo("A") + (testSet ? 1 : 61), s);
  ...
  private static Pair[] pa(int num, Pair obj)
  {
    Pair[] ret = new Pair[num];
    for (int i = 0; i<ret.length; i++)
      ret[i] = new Pair(obj.a,obj.b);
    return ret;
  }
